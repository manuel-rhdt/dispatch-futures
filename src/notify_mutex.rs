...
unsafe impl<D: Send> Send for NotifyMutex<D> {}
unsafe impl<D: Send> Sync for NotifyMutex<D> {}
...
impl<D> NotifyMutex<D> {
    pub fn new(data: D) -> NotifyMutex<D> {
        NotifyMutex {
                    ...
                    match self.status.compare_exchange(
                        ...
                        Ok(_) => {
                            let data = unsafe {
                                ...
                                // and we won't transition back to WAITING until
